...
![alt text](week2_image/image.png)

> **세미콜론으로 양수, 음수, 0, 텍스트 서식을 구분한다(115 ~ 117p)를 진행 후 인증사진을 첨부해주세요.**
![alt text](week2_image/image-1.png)
![alt text](week2_image/image-2.png)

## 03-2. 실무자를 위한 셀 표시 형식 대표 예제
> **0 지우거나 하이픈[-]으로 표시하기(119 ~121p)를 진행 후 인증사진을 첨부해주세요.**
![alt text](week2_image/image-3.png)

> **날짜를 년/월/일 [요일]로 표시하기(121 ~122p)를 진행 후 인증사진을 첨부해주세요.**
![alt text](week2_image/image-4.png)
![alt text](week2_image/image-5.png)
![alt text](week2_image/image-6.png)
![alt text](week2_image/image-7.png)

## 03-3. 깔끔한 보고서 작성을 위한 기본 규칙
> **깔끔한 보고서 완성하기(131 ~134p)를 진행 후 인증사진을 첨부해주세요.**
![alt text](week2_image/image-8.png)
![alt text](week2_image/image-9.png)
![alt text](week2_image/image-10.png)

## 03-4. 조건부 서식으로 빠르게 데이터 분석하기
> **특정 값보다 크거나 작을 때 강조하기(137 ~139p)를 진행 후 인증사진을 첨부해주세요.**
![alt text](week2_image/image-11.png)

> **조건을 만족할 때 전체 행 강조하기(141 ~142p)를 진행 후 인증사진을 첨부해주세요.**
![alt text](week2_image/image-12.png)

> **여러 조건에 모두 만족하는 셀 강조하기(143 ~144p)를 진행 후 인증사진을 첨부해주세요.**
![alt text]week2_image/(image-13.png)
![alt text](week2_image/image-14.png)
